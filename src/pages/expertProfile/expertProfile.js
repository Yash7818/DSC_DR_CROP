      ...
      <ThemeProvider theme={theme}>
        ...
        >
          <Badge
            ...
            badgeContent={
              <IconButton style={{ background: "#4caf50" }}>
                <CreateIcon />
              </IconButton>
            }
          >
            <Avatar
              ...
              src="https://res.cloudinary.com/marcos-yash/image/upload/v1616877820/avatar1_kijavl_iopsya.png"
            ></Avatar>
          </Badge>
          <Typography
            align="center"
            style={{ color: "#fff", fontSize: "1.5em", marginTop: "1em" }}
          >
            @{expertInfo.name}
          </Typography>
        </Grid>
                ...
                <Grid item container justify="space-between">
                  ...
                  >
                    <Link
                      ...
                      to={`/chat?name=${expertInfo.name}&room=${item.mediumLink}`}
                    >
                      Get In
                    </Link>
                  </Button>
